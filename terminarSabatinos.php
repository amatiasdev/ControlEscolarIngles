...
$existeGrupo="SELECT count(*) FROM grupos WHERE activo=1 and (horario='SABATINO MATUTINO' or horario='SABATINO VESPERTINO')";
$respExisteGrupo=$conexion->query($existeGrupo);
$respExisteGrupo=$respExisteGrupo->fetch_assoc();
if($respExisteGrupo['count(*)']>0){
$query2="SELECT idgrupo FROM grupos WHERE activo=1 and (horario='SABATINO MATUTINO' or horario='SABATINO VESPERTINO')";
...
$numeroGrupos="SELECT count(*) FROM grupos WHERE activo=1 and (horario='SABATINO MATUTINO' or horario='SABATINO VESPERTINO')";
